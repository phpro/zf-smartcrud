...
/**
 * Class ViewStrategySpec
 *
 * @package spec\PhproSmartCrud\View\Strategy
 */
class ViewStrategySpec extends AbstractStrategySpec
{
     ...
     * @param \PhproSmartCrud\View\Model\ViewModel $model
     * @param \Zend\Http\PhpEnvironment\Request $request
     * @param \Zend\Http\PhpEnvironment\Response $response
     */
    public function it_should_render_on_view_model($mvcEvent, $model, $request, $response)
    {
